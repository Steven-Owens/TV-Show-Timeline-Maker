...
import TVShowTimelineMaker.timeConstraints.IntervalConstraint;
...
public class IntervalConstraintEditor extends ConstraintEditorWindow {
    
    @com.civprod.dynamicClassLoading.ClassInitalizer
        public static final void addMe() {
            ConstraintEditorWindow.addConstraintEditor(IntervalConstraint.class, IntervalConstraintEditor.class);
        }
    
    IntervalConstraint mIntervalConstraint;
    Interval mInterval;
    ...
    public IntervalConstraintEditor(){
        this(new IntervalConstraint(Main.myShow.getTimeLine().anyEventOfType(OnceEvent.class), new Interval(0,0)));
    }
    /**
     * Creates new form IntervalConstraintEditor
     * @param inIntervalConstraint
     */
    public IntervalConstraintEditor(IntervalConstraint inIntervalConstraint) {
        this.initComponents();
        CollectionListModel<OnceEvent> tempModel = new CollectionListModel<>();
        ...
        this.mIntervalConstraint = inIntervalConstraint;
        this.mInterval = this.mIntervalConstraint.getmInterval();
        ...
        this.listEvent.setSelectedValue(this.mIntervalConstraint.getConstrainedEvents()[0], true);
        this.validate();
    }
    ...
    private void initComponents() {
        ...
        listEvent = new javax.swing.JList<TVShowTimelineMaker.timeline.OnceEvent>();
    ...
    private void cmdCommitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCommitActionPerformed
        ...
        this.txtDateTimeLabel.setText(this.mInterval.toString());
        this.mIntervalConstraint = new IntervalConstraint(this.listEvent.getSelectedValue(), this.mInterval);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntervalConstraintEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new IntervalConstraintEditor().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<TVShowTimelineMaker.timeline.OnceEvent> listEvent;
    ...
    public TimeConstraint getValue() {
        return this.mIntervalConstraint;
    }
    private static final Logger LOG = Logger.getLogger(IntervalConstraintEditor.class.getName());
}
